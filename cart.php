...
if(isset($_POST['update_update_btn'])){
   ...
   mysqli_query(
      ...
      "UPDATE `cart` 
       ...
       WHERE id='$update_id' AND user_email='$user_email'"
   );
...
if(isset($_GET['remove'])){
   ...
   mysqli_query(
      $conn,
      "DELETE FROM `cart` 
       WHERE id='$remove_id' AND user_email='$user_email'"
   );
...
<section class="shopping-cart">
   ...
   <div class="checkout-btn">
      <a href="checkout.php" class="btn <?= ($total > 1)?'':'disabled'; ?>">procced to checkout</a>
   </div>
